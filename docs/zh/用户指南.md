...
![photo](../images/create_virtual_environment.png)

单击`Add new Interpreter`, 再单击`Add Local Interpreter...`
![photo](../images/create_virtual_environment_1.png)
   
选择python版本和路径，单击`ok`即可
